...
public class New_Goods_Address_Activity extends Activity {
	...
	private void viewId() {
		...
		relayout_city.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if (pCodeString==null) {
					Toast.makeText(getApplicationContext(),"请选择省份后在操作", Toast.LENGTH_SHORT).show();
					return;
				}else {
		...
		relayout_area.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if (cCodeString==null) {
					Toast.makeText(getApplicationContext(),"请选择城市后在操作", Toast.LENGTH_SHORT).show();
					return;
				}else {
	...
	private void volleyPost(){
		...
		if (TextUtils.isEmpty(name)) {
			...
			return;
		}if (area.equals("请选择县/区")) {
			Toast.makeText(getApplicationContext(), "县/区不能为空",Toast.LENGTH_SHORT).show();
			return;
			...
			VolleyRequest.RequestPost(this,Urls.ADD_RECEIVE_ADDRESS,"ADD_RECEIVE_ADDRESS", map,
